...
sudo pacman -S --noconfirm pulseaudio pulseaudio-alsa ntfs-3g openssh xorg xorg-xinit wget zsh openrc-zsh-completions bspwm sxhkd feh rofi alacritty # kdeconnect connman-gtk
